...
class AdvancedTradingConfig:
    ...
    def __init__(self):
        ...
        self.MIN_NEURAL_DESTACADA = 90.0      # IA mínima para DESTACADA (+5%)
        self.MIN_TECHNICAL_DESTACADA = 90.0   # Técnico mínimo para DESTACADA (+5%)
        self.MIN_ALIGNMENT_DESTACADA = 90.0   # Alineación mínima para DESTACADA
